...
} from "./chunk-AZ7WLGLQ.js";
import {
  clsx_m_exports,
  init_clsx_m
} from "./chunk-WAM5SGDT.js";
import {
  require_js
} from "./chunk-ZKMJNKGX.js";
import {
  __commonJS,
  __esm,
  __export,
...
var require_sha256 = __commonJS({
  "node_modules/js-sha256/src/sha256.js"(exports, module) {
    ...
    (function() {
      ...
      var NODE_JS = !root.JS_SHA256_NO_NODE_JS && typeof import_process.default === "object" && import_process.default.versions && import_process.default.versions.node;
      if (NODE_JS) {
        root = global;
      } else if (WEB_WORKER) {
        root = self;
    ...
    function solidityPack(types, values) {
      ...
      for (var i3 = 0; i3 < types.length; i3++) {
        ...
        if (type === "bytes") {
          ...
          ret.push(num.toArrayLike(import_buffer.Buffer, "be", size / 8));
        } else if (type.startsWith("int")) {
          size = parseTypeN(type);
          if (size % 8 || size < 8 || size > 256) {
            throw new Error("Invalid int<N> width: " + size);
          ...
          ret.push(num.toTwos(size).toArrayLike(import_buffer.Buffer, "be", size / 8));
        } else {
          throw new Error("Unsupported or invalid type: " + type);
        }
      }
...
function z(l3, u3, t3, i3, o3, r3, f3, e3, c3) {
  ...
  if (null === b3)
    ...
    else if (p3 && (l3.innerHTML = ""), S(l3, y(v3) ? v3 : [v3], u3, t3, i3, "foreignObject" === b3 ? "http://www.w3.org/1999/xhtml" : o3, r3, f3, r3 ? r3[0] : t3.__k && x(t3, 0), e3, c3), null != r3)
      for (s3 = r3.length; s3--; )
        null != r3[s3] && w(r3[s3]);
  ...
  "node_modules/walletlink/dist/components/Snackbar.js"(exports2) {
    ...
    var SnackbarInstance = ({ autoExpand, message, menuItems }) => {
      ...
      return (0, preact_1.h)(
        ...
        menuItems && menuItems.length > 0 && (0, preact_1.h)("div", { class: "-walletlink-snackbar-instance-menu" }, menuItems.map((action, i3) => (0, preact_1.h)(
          "div",
          { class: (0, clsx_1.default)("-walletlink-snackbar-instance-menu-item", action.isRed && "-walletlink-snackbar-instance-menu-item-is-red"), onClick: action.onClick, key: i3 },
          (0, preact_1.h)(
            "svg",
...
var require_WalletLinkRelay = __commonJS({
  "node_modules/walletlink/dist/relay/WalletLinkRelay.js"(exports2) {
    ...
    var WalletLinkRelay = class _WalletLinkRelay extends WalletLinkRelayAbstract_1.WalletLinkRelayAbstract {
      constructor(options) {
        super();
        ...
        this.subscriptions.add(
          this.connection.incomingEvent$.pipe((0, operators_1.filter)((m3) => m3.event === "Web3Response")).subscribe({ next: this.handleIncomingEvent })
      ...
      handleWeb3ResponseMessage(message) {
        ...
        if ((0, Web3Response_1.isRequestEthereumAccountsResponse)(response)) {
          Array.from(_WalletLinkRelay.accountRequestCallbackIds.values()).forEach((id) => this.invokeCallback(Object.assign(Object.assign({}, message), { id })));
          _WalletLinkRelay.accountRequestCallbackIds.clear();
          return;
        }
...
var require_WalletLink = __commonJS({
  "node_modules/walletlink/dist/WalletLink.js"(exports2) {
    ...
    var util_1 = require_util();
    var WALLETLINK_URL = import_process.default.env.WALLETLINK_URL || "https://www.walletlink.org";
    var WALLETLINK_VERSION = import_process.default.env.WALLETLINK_VERSION || require_package().version || "unknown";
    var WalletLink = class _WalletLink {
      /**
       * Constructor
      ...
      constructor(options) {
        ...
        this._storage.setItem("version", _WalletLink.VERSION);
